...
const Index = ({ autoPlayFailed }) => {
    ...
    useEffect(() => {
        ...
        if (sessionStorage.getItem("id")) {
            updateDoc(`/players/${sessionStorage.getItem("id")}`, {
                gameKey: "",
            });
        }
        ...
        <PageContainer>
            {!access_token ? (
                <SpotifyAccess>
                    ...
                    <p>
                        This game uses your favorite songs to create a music
                        playlist together with your friends. <br />
                        <br />
                        Please Note: <br />
                        1. It is only playable if you have Spotify premium{" "}
                        <br />
                        2. This app is in development mode meaning that you need
                        to be added as a user by the admin to be aple to play. If you are intreseted to try it reach out to ivan.k@live.se
                    </p>
                    <SpotifyLogInButton
                    ...
                    {autoPlayFailed && !autoPlayActive ? (
                        <AutoPlayContainer>
                            <div>
                                ...
                                <p>
                                    This game requires autoplay to function. To
                                    ensure it works properly, please enable
                                    autoplay by clicking the button below.{" "}
                                    <br /> <br />
                                    OBS! If the game still doesn't work, it
                                    could be because you don't have an instance
                                    of Spotify open. To make sure you have an
                                    instance active open Spotify and play a
                                    song. After which you can return back to the
                                    website.
                                </p>
                            </div>
